  ...
  protected readonly partners = signal<Partner[]>([
    {
      ...
      description:
        'Deploying secure, low-latency deep learning neural models at edge networks.',
      color: '#38bdf8',
    },
    {
      name: 'Novgorod Tech',
      ...
      description:
        'Distributed cloud computing layers featuring instant replication databases.',
      color: '#10b981',
    },
    {
      name: 'Turing Crypto',
      ...
      description:
        'Validating encrypted transactions securely without revealing private key tokens.',
      color: '#f43f5e',
    },
    {
      ...
      description:
        'Self-assembling processor threads that automatically scaling node bandwidth.',
      color: '#a855f7',
    },
    {
      name: 'Novum Edge',
      ...
      description:
        'Serverless execution instances running microservice bundles worldwide.',
      color: '#fb923c',
    },
    {
      name: 'Apex Shield',
      ...
      description:
        'Enterprise credentials validation using multi-factor biometric systems.',
      color: '#facc15',
    },
  ]);
