...
import { StarDecorationComponent } from '@shared/components/starDecoration/starDecoration.component';
...
export class BannerComponent {
  customStyles: ICustomStyles = {
    ...
    padding: '.8rem 1.8rem',
    background:
      'linear-gradient(60deg, rgba(242, 7, 15, 0.6), rgba(120, 2, 255, 0.6))',
  };
}
